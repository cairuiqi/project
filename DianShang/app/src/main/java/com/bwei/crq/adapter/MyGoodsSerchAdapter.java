 ...
 * @Description:
 */
public class MyGoodsSerchAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<GoodsSerchJson.ResultBean> list;
...
*/
    ...
    public MyGoodsSerchAdapter(Context context,  List<GoodsSerchJson.ResultBean> list) {
